...
| ->         | [Account](https://github.com/joni0108/MQL-SDK/tree/main/docs/mql5/account.md) | modules/mql5/account.mqh             | Handle all the account-related information.                                                   | 1.0               |
| ->         |                                       Terminal                                        | modules/mql5/terminal.mqh            | Handle all the terminal-related information.                                                  | Under Development |
| ->         |                                        Market                                         | modules/mql5/market.mqh              | Handle all the market-related information                                                     | Under Development |
| ->         |                                         Trade                                         | modules/mql5/trade.mqh               | Send, Manage, and handle orders and positions                                                 | Under Development |
| ->         |                                      Indicators                                       | modules/mql5/insdicators.mqh         | Handle the indicators                                                                         | Under Development |
| ->         |                                         Files                                         | modules/mql5/files.mqh               | Handle different files types, including .sets, .logs and .dat                                 | Under Development |
